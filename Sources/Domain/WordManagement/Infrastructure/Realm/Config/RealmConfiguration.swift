...
internal let realmExecutionQueue = DispatchQueue(label: "realm-serial-queue-default", qos: .userInitiated)
...
private func migrate7to8(_ migration: Migration) {
    migration.enumerateObjects(ofType: WordObject.className()) { _, newObject in
