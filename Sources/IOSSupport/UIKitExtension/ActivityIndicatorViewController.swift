...
public final class ActivityIndicatorViewController: UIViewController {
    ...
    public static let shared: ActivityIndicatorViewController = .init()
    ...
    public func startAnimating(on viewController: UIViewController) {
        viewController.present(self, animated: false)
        activityIndicatorView.startAnimating()
    }

    public func stopAnimating(on viewController: UIViewController) {
